                ...
                <div className="container position-relative zindex-5 pt-5">
                  <div className="row">
                    <div className="col-lg-6">
                      ...
                      <h1 className="pb-2 pb-md-3">About Homegrown</h1>
                      <h3 className="pb-2 pb-md-3">The Future platform for empowerment groups:</h3>
                      <p
                        className="fs-xl pb-4 mb-1 mb-md-2 mb-lg-3"
                        style={{ maxWidth: 526 }}
                      >
                  By powering the future of Homegrown with our retail partners, 
